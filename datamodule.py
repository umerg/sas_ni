...
class MovieDataModule(LightningDataModule):
        ...
        for user in user_seq_dict:
            ...
            if count > 2*split_num:
                ...
                if self.block == "full":
                    ...
                    test_window = time_diffs_u.index[(time_diffs_u <= datetime.timedelta(days = t))].tolist()
                    test_select = time_diffs_u.index[(time_diffs_u <= datetime.timedelta(days = bp)) & (time_diffs_u > datetime.timedelta(days = 0))].tolist()
    ...
    def train_dataloader(self):
        ...
        train_dataset = TrainDataset(self.user_seq_train, self.item_n, self.config.max_seq_len)
