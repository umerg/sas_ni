...
class TrainDataset(Dataset):
    def __init__(self, data, item_n, max_seq_len):
        self.data = list(data.values()) #list of the input sequences (untruncated)
        self.item_n = item_n
    ...
    def __getitem__(self, idx):
        ...
        ts = set(original_seq)
        for i in reversed(original_seq[:-1]):
            seq[idx] = i
            pos[idx] = nxt
